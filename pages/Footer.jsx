    ...
    <footer>
      <div className="mb-[20px] mt-[60px] flex minxs:flex max-w-full overflow-y-auto">
        ...
        <div className="text-[19px]">
          <Link
            className=" text-gray-500 dark:text-white hover:text-gray-900 dark:hover:text-white transition items-center inline-flex"
        ...
        <div className="text-[19px]">
          <Link
            className=" text-gray-500 dark:text-white hover:text-gray-900 dark:hover:text-white transition items-center inline-flex pl-2"
